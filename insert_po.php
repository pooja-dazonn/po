...
$price_term=$_SESSION["price_term"];
...
<div class="w3-sidebar w3-bar-block w3-border-right" style="display:none" id="mySidebar">
       ...
       <div class="form-group">
        ...
        $query="select suppliername,address,iec,gstno from supplier ";
        ...
        ?>
         ...
         <option name="data"><?php echo $user1['suppliername'];?>,<br><?php echo $user1['address'];?>,<?php echo $user1['iec'];?>,<?php echo $user1['gstno'];?></option>
...
<!-- Text input-->
     <div class="form-group">
        <label class="col-md-4 control-label" >ORDER DATE</label> 
           <div class="col-md-4 inputGroupContainer">
             <div class="input-group">
               <input name="o_date"  id="fromDate" placeholder="Order Date:" class="form-control"  type="text" value="<?php echo $o_date; ?>" autocomplete="off" required >
             </div>
           </div>
      </div>
<!-- Text input-->
       <div class="form-group">
          <label class="col-md-4 control-label">DELIVERY DATE</label>  
             <div class="col-md-4 inputGroupContainer">
               <div class="input-group">
                  <input name="d_date" id="toDate" placeholder="Delivary Date:" class="form-control" type="text"  value="<?php echo $d_date; ?>" autocomplete="off"  required>
               </div>
              </div>
          </div>
   <!-- Text input-->
        <div class="form-group">
           <label class="col-md-4 control-label">DESTINATION</label>  
              <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
                   <select name="desti" placeholder="destination" id="desti"   required >
...
<?php
               if(isset($_POST["btn"]))
               {
                $query="SELECT id,CODE,DESCRIPTION,WM,TM,DM,TYPE,FINISH,COLOUR,QTY,SQM,KGS,RATE, ROUND(QTY*SQM,4) as sqm,ROUND(QTY*KGS,4)as kgs,(QTY*RATE) as TOTAL from po where TYPE='".$_POST['category']."'";
